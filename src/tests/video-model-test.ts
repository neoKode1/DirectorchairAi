...
describe("Video Model Configuration", () => {
  ...
  describe("Image to Video", () => {
    ...
    test("should validate image URL format", () => {
      ...
      validUrls.forEach((url) => {
        ...
        expect(mockPayload.image_url).toMatch(
  ...
  describe("Video to Video", () => {
    ...
    test("should validate video URL format", () => {
      ...
      validUrls.forEach((url) => {
        ...
        expect(mockPayload.video_url).toMatch(
  ...
  describe("Common Validations", () => {
    ...
    test("should validate default values", () => {
      ...
      expect(fullPayload.num_inference_steps).toBe(
        defaultValues.num_inference_steps,
      );
      ...
      expect(fullPayload.noise_aug_strength).toBe(
        defaultValues.noise_aug_strength,
      );
    });
  });
});
