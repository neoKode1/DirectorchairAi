  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-8 w-full rounded-md border border-transparent bg-muted/50 focus:bg-muted/70 px-2 py-1 mobile-text-xs sm:text-sm",
          ...
          "disabled:cursor-not-allowed disabled:opacity-50 mobile-touch-target",
          className,
        )}
        ref={ref}
        {...props}
