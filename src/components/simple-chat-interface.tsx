            ...
            <div className="flex items-center gap-2">
              ...
              <Select value={preferredVideoModel} onValueChange={setPreferredVideoModel}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="xai/grok-imagine-video/text-to-video">Grok Imagine Video</SelectItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={preferredVideoModel} onValueChange={setPreferredVideoModel}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="xai/grok-imagine-video/text-to-video">Grok Imagine Video - Text-to-video with audio, 1-15s</SelectItem>
