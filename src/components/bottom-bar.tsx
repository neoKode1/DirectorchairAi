...
export default function BottomBar() {
  ...
  return (
    <div className="border-t border-border/40 flex flex-col bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="border-b border-border/40 bg-background/80 backdrop-blur px-4 flex flex-row gap-8 py-3 justify-between items-center flex-1">
        <div className="h-full flex flex-col justify-center px-4 bg-background/60 backdrop-blur rounded-lg font-mono cursor-default select-none border border-border/20">
      ...
      <div
        className={cn(
          "min-h-64 max-h-72 h-full flex flex-row overflow-y-scroll transition-colors p-4",
          {
            "bg-accent/20": dragOverTracks,
          },
        )}
