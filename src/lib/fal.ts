...
export const AVAILABLE_ENDPOINTS: ApiInfo[] = [
  ...
  },
  {
    ...
    label: "Nano Banana 2",
    description: "Google's latest state-of-the-art image generation and editing model with image, video, audio, PDF context, web search, thinking levels, and 0.5K-4K outputs",
    category: "image",
    inputAsset: ["image"],
    supportsMultipleImages: true,
    maxImages: 4,
  ...
  },
  {
    ...
    label: "Grok Imagine Image Quality (T2I)",
    description: "xAI Grok Imagine Pro quality text-to-image model with 1K/2K outputs, strong typography, and enhanced realism",
    category: "image",
    initialInput: {
  ...
  {
    endpointId: "xai/grok-imagine-image/quality/edit",
    label: "Grok Imagine Image Quality Edit",
    description: "xAI Grok Imagine Pro quality image editing model with optional multi-image inputs, 1K/2K outputs, and stronger visual fidelity",
    category: "image",
    inputAsset: ["image"],
    supportsMultipleImages: true,
    maxImages: 3,
  ...
  },
  {
    ...
    description: "Extend an existing MP4 video by 2-10 seconds using xAI's Grok Imagine video model",
    category: "video",
    inputAsset: ["video"],
    initialInput: {
  ...
  },
  {
    ...
    description: "Edit existing videos using xAI's Grok Imagine model with text-guided transformations and auto/480p/720p output resolution",
    category: "video",
    inputAsset: ["video"],
    initialInput: {
  ...
  },
  {
    ...
    label: "Seedance 2.0 Premium (T2V)",
    description: "ByteDance's most advanced full-tier text-to-video model with cinematic output, native audio, 480p-4K resolution, and director-level camera control",
    category: "video",
    initialInput: {
      prompt: "An octopus finds a football in the ocean and excitedly calls its octopus friends to come and play. Cut to an octopus football game under the sea.",
      resolution: "720p",
  ...
  },
  {
    ...
    label: "Seedance 2.0 Premium (I2V)",
    description: "ByteDance's full-tier image-to-video model with synchronized audio, start/end frame control, and 480p-4K output options",
    category: "video",
    inputAsset: ["image"],
    supportsMultipleImages: true,
    maxImages: 2,
  ...
  },
  {
    ...
    label: "Seedance 2.0 Premium (Reference-to-Video)",
    description: "ByteDance's full-tier reference-to-video model using up to 9 images, 3 videos, and 3 audio clips with native audio and 480p-4K output",
    category: "video",
  ...
  },
  {
    ...
    label: "Luma Ray 3.2 (T2V)",
    description: "Luma Ray 3.2 cinematic text-to-video with 540p/720p/1080p, 5s/10s durations, seamless loop support, and optional HDR/EXR exports",
    category: "video",
    initialInput: {
  ...
  },
  {
    ...
    label: "Luma Ray 3.2 (I2V)",
    description: "Luma Ray 3.2 image-to-video model for cinematic motion from a starting image, with optional end frame, keyframes, HDR, and 540p/720p/1080p output",
    category: "video",
    inputAsset: ["image"],
    supportsMultipleImages: true,
    maxImages: 2,
  ...
  },
  {
    ...
    label: "Luma Ray 3.2 (V2V)",
    description: "Luma Ray 3.2 video-to-video re-rendering for restyling existing footage while preserving source motion, with optional start image, edit strength, HDR, and EXR export",
    category: "video",
    inputAsset: ["video"],
    initialInput: {
  ...
  },
  {
    ...
    label: "Luma Ray 3.2 Reframe",
    description: "Luma Ray 3.2 video reframing/outpainting to a new aspect ratio while preserving the original source footage frame-for-frame",
    category: "video",
    inputAsset: ["video"],
    initialInput: {
  ...
  {
    endpointId: "luma/agent/uni-1/v1/text-to-image",
    label: "Luma Uni-1 (T2I)",
    description: "Luma Uni-1 text-to-image for high-fidelity single-image generation with optional web search and reference image guidance",
    category: "image",
    supportsMultipleImages: true,
    initialInput: {
  ...
  {
    endpointId: "luma/agent/uni-1/v1/max",
    label: "Luma Uni-1 Max (T2I)",
    description: "Luma Uni-1 Max text-to-image at highest fidelity for hero-quality stills with richer detail and stronger prompt adherence",
    category: "image",
    supportsMultipleImages: true,
    initialInput: {
      prompt: "A manga panel of a stoic samurai overlooking a neon cyberpunk city at dusk.",
  ...
  {
    endpointId: "luma/agent/uni-1/v1/edit",
    label: "Luma Uni-1 Edit",
    description: "Luma Uni-1 image editing model for text-guided edits that preserve the source composition and can use optional reference images",
    category: "image",
    inputAsset: ["image"],
    supportsMultipleImages: true,
    initialInput: {
  ...
  {
    endpointId: "luma/agent/uni-1/v1/max/edit",
    label: "Luma Uni-1 Max Edit",
    description: "Luma Uni-1 Max Edit applies maximum-fidelity text-guided edits to a source image with optional reference images for precise revisions",
    category: "image",
    inputAsset: ["image"],
    supportsMultipleImages: true,
    initialInput: {
  ...
  },
  {
    ...
    label: "xAI TTS v1",
    description: "Expressive and realistic xAI text-to-speech with five voices, automatic language detection, and speech tags like [laugh], [pause], and <whisper>",
    category: "voiceover",
    initialInput: {
