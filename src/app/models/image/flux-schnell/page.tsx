...
import { FluxSchnellModelInterface, FluxSchnellModelInput } from "@/components/model-inputs/flux-schnell-model-interface";
...
export default function FluxSchnellPage() {
  ...
  const handleSubmit = async (input: FluxSchnellModelInput): Promise<{ images: { url: string }[] }> => {
    try {
      setIsLoading(true);
    ...
    <div className="container mx-auto py-6">
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <FluxSchnellModelInterface modelInfo={modelInfo} onSubmit={handleSubmit} />
        </CardContent>
      </Card>
